...
android {
    namespace = "com.inomotech.canrosetta.companion"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.inomotech.canrosetta.companion"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "0.1.0"
...
dependencies {
    // Compose BOM keeps all Compose artifacts on a mutually compatible set.
